...
class _ChatState extends State<Chat> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text("Messenger DE", style: TextStyle(fontWeight: FontWeight.bold),),
        elevation: 0.0,
        centerTitle: true,
      ),
      body: Container(
  ...
  Widget build(BuildContext context) {
    return Container(
      padding: EdgeInsets.only(
          top: 2, bottom: 2, left: sendByMe ? 0 : 24, right: sendByMe ? 24 : 0),
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
            ...
            gradient: LinearGradient(
              colors: sendByMe
                  ? [const Color(0xFFFFFFF), const Color(0xff2A75BC)]
